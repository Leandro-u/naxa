...
ctx.lineWidth = 1;
ctx.rect(x, y, width, height, 150, 143, 430, 200);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(x, y, r, startAngle, endAngle, 150 , 143 , 40 , 0 , 2*Math.PI);
ctx.stroke(); 

ctx.beginPath();
ctx.strokeStyle = "black";
ctx.lineWidth = 5;
ctx.arc(x, y, r, startAngle, endAngle, 350 , 210 , 40 , 0 , 2*Math.PI);
ctx.stroke();

ctx.beginPath();
ctx.strokeStyle = "red";
ctx.lineWidth = 5;
ctx.arc(x, y, r, startAngle, endAngle, 210 , 40 , 40 , 0 , 2*Math.PI);
ctx.stroke(); 

ctx.beginPath();
ctx.strokeStyle = "orange";
ctx.lineWidth = 5;
ctx.arc(x, y, r, startAngle, endAngle, 300 , 250 , 40 , 0 , 2*Math.PI);
ctx.stroke();

ctx.beginPath();
ctx.strokeStyle = "green";
ctx.lineWidth = 5;
ctx.arc(x, y, r, startAngle, endAngle, 400 , 250 , 40 , 0 , 2*Math.PI);
ctx.stroke(); 
